:: ----------------------
:: This script is a modified version of the Kudu Node deployment script obtained from the Kudu deployment site
:: or by running the kuduscript tool.
:: ----------------------
...
IF EXIST "%1\package.json" (
  pushd "%1"
  :: Modified from default script to perform build
  call npm install
  IF !ERRORLEVEL! NEQ 0 goto error
