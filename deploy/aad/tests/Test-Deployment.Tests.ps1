Param(
    ...
    [string]
    $TemplateFile = '../splunk-aad-logs-deploy-resources.json',
    # Location
    [Parameter(Mandatory = $false)]
    [string]
    $Location = "East US",
...
Describe "Azure ARM Template Unit Tests" {
    BeforeAll {
        ...
        $eventHubAuthRuleListen = "splk-aad-logs-eventhub-auth-listen"
        $eventHubAuthRuleSend = "splk-aad-logs-eventhub-auth-send"
