...
4. Powershell and modules (Install latest version).
   ...
   - `Pester` for ARM template unit tests
     ```
     Install-Module -Name Pester
     ```
   - `Az` for managing Azure resources from PowerShell. See [detail installation guide](https://learn.microsoft.com/en-us/powershell/azure/install-az-ps) here if you encounter issues:
     ```
